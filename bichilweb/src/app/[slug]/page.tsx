/**
 * Top-level dynamic page route.
 * Catches URLs like /aaw, /custom-page etc. that are created
 * via the admin page builder with custom URLs.
 *
 * Explicit routes (/about, /news, /branches, /services, /products, /pages, /calculator)
 * take priority over this [slug] route in Next.js App Router.
 */
...
// ═══════════════════════════════════════════════════════════════════════════════
// BLOCK TYPES & RENDERER (same as pages/[slug])
// ═══════════════════════════════════════════════════════════════════════════════
