...
interface LoanCalculatorProps {
  ...
  compact?: boolean;
  // Button & disclaimer styling (from product details)
  calcBtnColor?: string;
...
export default function LoanCalculator({
  ...
  const [loanAmount, setLoanAmount] = useState<string>(
    String(Math.round(maxAmount / 2))
  );
  const [loanTerm, setLoanTerm] = useState<string>(
    String(Math.min(12, maxTerm))
  );
  ...
  const calculateLoan = () => {
    ...
    // Principal = requested amount minus down payment
  ...
  return (
    <div className={`bg-white border border-[#00B2E7]/20 rounded-2xl shadow-sm ${compact ? "p-4" : "p-6"}`}>
      {/* Header */}
      <div className="flex items-center gap-2 mb-4">
        <div className="w-8 h-8 bg-gradient-to-br from-[#00B2E7] to-[#0048BA] rounded-lg flex items-center justify-center">
      ...
      <div className="space-y-4">
        {/* Loan Amount — slider from 0 to maxAmount */}
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#00B2E7] focus:border-[#00B2E7]"
            />
          ...
          <input
            ...
            className="mt-2 w-full accent-[#0048BA] h-1.5"
          />
        ...
        {/* Down Payment — read-only display */}
        {downPaymentPercent > 0 && (
          <div>
        ...
        {/* Loan Term — slider from 0 to maxTerm */}
        <div>
        ...
        {showResults && monthlyPayment !== null && (
          <div className="space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="relative rounded-lg overflow-hidden border border-[#00B2E7]/30 bg-gradient-to-br from-[#00B2E7]/10 to-[#0048BA]/10 p-3">
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-0 w-1.5 h-full bg-gradient-to-b from-transparent via-[#00B2E7] to-transparent animate-scan-line shadow-[0_0_15px_rgba(0,178,231,0.8)]" />
              </div>
              <div className="relative z-10">
                <p className="text-[10px] font-medium text-[#0048BA] mb-0.5">Сарын төлбөр</p>
                <div className="text-lg font-bold text-[#0048BA]">₮{formatNumber(monthlyPayment)}</div>
                <p className="text-[10px] text-[#0048BA]/70">/ сар</p>
              </div>
            </div>
